...
public:
    ...
    void setupUi(QWidget *FrameLessDemoClass)
    {
        if (FrameLessDemoClass->objectName().isEmpty())
            FrameLessDemoClass->setObjectName(QString::fromUtf8("FrameLessDemoClass"));
        FrameLessDemoClass->resize(800, 600);
        verticalLayout_2 = new QVBoxLayout(FrameLessDemoClass);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setContentsMargins(11, 11, 11, 11);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(4, 4, 4, 4);
        windowFrame = new QWidget(FrameLessDemoClass);
...
"  padding:4px;\n"
"  \n"
"	image: url(:/FrameLessDemo/images/icon_window_minimize.png);\n"
"}\n"
...
"  height:16px;\n"
"  padding:4px;\n"
"  image:url(:/FrameLessDemo/images/icon_window_restore.png);\n"
"}\n"
"#restoreButton:hover{\n"
"  background-color:palette(alternate-base);\n"
"}\n"
...
"  height:16px;\n"
"  padding:4px; \n"
"  image: url(:/FrameLessDemo/images/icon_window_maximize.png);\n"
"}\n"
...
"  height:16px;\n"
"  padding:4px;\n"
"  image: url(:/FrameLessDemo/images/icon_window_close.png);\n"
...
"}"));
        ...
        windowToolbar = new WindowDragger(windowFrame);
        ...
        windowToolbar->setMinimumSize(QSize(0, 0));
        windowToolbar->setAutoFillBackground(false);
        windowToolbar->setStyleSheet(QString::fromUtf8("#windowToolbar{border: 0px none palette(base); background-color: rgb(80, 80, 80); height:20px;}"));
        horizontalLayout_2 = new QHBoxLayout(windowToolbar);
        horizontalLayout_2->setSpacing(0);
        horizontalLayout_2->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_2->setObjectName(QString::fromUtf8("horizontalLayout_2"));
        horizontalLayout_2->setContentsMargins(0, 0, 0, 0);
        spacer_2 = new QLabel(windowToolbar);
        spacer_2->setObjectName(QString::fromUtf8("spacer_2"));
        spacer_2->setMinimumSize(QSize(4, 27));
        spacer_2->setMaximumSize(QSize(4, 16777215));

        horizontalLayout_2->addWidget(spacer_2);

        comboBox = new QComboBox(windowToolbar);
...
"}"));
    ...
    {
        FrameLessDemoClass->setWindowTitle(QCoreApplication::translate("FrameLessDemoClass", "FrameLessDemo", nullptr));
        titleText->setText(QCoreApplication::translate("FrameLessDemoClass", "Frameless Window (Dark Style)", nullptr));
